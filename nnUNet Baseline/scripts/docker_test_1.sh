...
SIF="${PROJECT_ROOT}/test/nnunet_baseline.sif"

INPUT="/projectnb/ec500kb/projects/Fall_2025_Projects/Project_4_VesselFM/data/nnUNet_raw/Dataset001_nnunet/imagesTs/case_005_0000.nii.gz"
